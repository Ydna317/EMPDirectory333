...
function Main(){
    ...
    async function getRandomUsers(){
        const result = await axios.get('https://randomuser.me/api/?results=333&seed=seed')
    ...
    return(
        <div className="container" style={{marginTop: "20px", marginBottom: "20px"}}>
            ...
            <div style={{display: "flex", justifyContent: "center",  margin: "auto", color: "gray"}}>
                <p><small>Hover over the Name, Phone Number, Email, or Location to Sort Employees</small></p>
            </div>
            <Table list={users} sortEmail={sortEmail} sortNumber={sortNumber} sortName={sortName} sortLocation={sortLocation}/>
        </div>
    )
}
